...
/*TongJing.Shi@EXP.DataComm.Phone, 2014.04.18, Add for exp just 3G no 4G*/
    ...
    OPERATOR_ALL_CHINA_CARRIER_UNICOM    = 0xA,    /*rendong.shi@Bsp.Group.Tp add for all china carrier UNICOM  phone, 2016/01/07*/
    OPERATOR_FOREIGN_EUROPE              = 0xB,    //wanghao@Bsp.Group.Tp add for foreign europe  phone, 2018/07/14
